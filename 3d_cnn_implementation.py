...
batch_size = 1
curr_dir = os.getcwd()
directory = os.path.join(curr_dir,'PPMI_new')
...
def input_model_fcn(features,labels,mode):
    ...
    conv1 = tf.layers.conv3d(inputs=features,filters=2,
    ...
    dense2 = tf.layers.dense(inputs=pool2_flat,units=128,activation=tf.nn.relu)
...
# eval_results = parkinson_classifier.evaluate(input_fn=eval_input_fn)
# print(eval_results)
>>>>>>> fc2c96ec9391c800588bd02ee73e6482ca775e6e
